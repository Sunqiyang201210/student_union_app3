...
const KeyboardAwareScrollable = ({
  ...
  const keyboardShouldPersistTaps = childAttrs['keyboardShouldPersistTaps'] as string | undefined;
  const keyboardDismissMode = childAttrs['keyboardDismissMode'] as string | undefined;
